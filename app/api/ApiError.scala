...
object ApiError {
  ...
  final val ERROR_USER_EXIST = 112
  final val ERROR_PHONE_NULL = 113
  final val ERROR_USER_DISABLE = 114
  ...
  final val ERROR_USER_ID = 301
  final val ERROR_UPDATE_PRODUCT_ID = 302
  final val ERROR_PRODUCT_NOT_FOUND = 303
  final val PRODUCT_NOT_MORE_THAN_FIVE = 304

  final val ERROR_CATEGORY_ID = 305
  final val ERROR_CATEGORY_NOT_FOUND = 306
  final val ERROR_PRODUCT_5 = 4
  final val ERROR_PRODUCT_200 = 199
